...
public class RotationLoader {
	...
	private static Hashtable<ResourceLocation, Hashtable<String, Hashtable<Integer, Integer>>> map = new Hashtable<ResourceLocation, Hashtable<String, Hashtable<Integer, Integer>>>();
	...
	public static void loadFromTextFile(String filePath) {
		try {
			...
			ResourceLocation blockIdentifier = null;
		    ...
		    while ((line = reader.readLine()) != null) {
				...
				if(type.equals("block"))
					blockIdentifier = new ResourceLocation(split[1]);
	...
	public static boolean onRotation(World world, BlockPos pos, ResourceLocation blockIdentifier, Block block, int meta, MovementType movementType) {
