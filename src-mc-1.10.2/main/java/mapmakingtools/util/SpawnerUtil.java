...
public class SpawnerUtil {
	...
	public static String getMobId(MobSpawnerBaseLogic spawnerLogic, int minecartIndex) {
		if(minecartIndex == -1)
			...
			WeightedSpawnerEntity randomMinecart = (WeightedSpawnerEntity)ReflectionHelper.getField(randomMinecartListField, List.class, spawnerLogic).get(minecartIndex);
